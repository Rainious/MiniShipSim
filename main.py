...
from minisim.control.scripts import rudder_step_script, speed_step_script, rudder_s_turn_script
...
def main():
    ...
    sim = run_offline_sim(dt, steps, rudder_s_turn_script, speed_step_script)
